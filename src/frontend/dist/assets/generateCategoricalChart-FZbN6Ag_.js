import { u as useActor, z as useQuery, g as createActor, f as unwrapResult, aj as commonjsGlobal, af as getDefaultExportFromCjs, r as reactExports, ab as clsx, R as React } from "./index-DqipwkTD.js";
function useGetComplianceRiskScore() {
...
function useGetPenaltyExposure() {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
export {
  ...
  Cell as U,
  getMaxRadius as V,
  getPercentValue as W,
  XAxis as X,
  YAxis as Y,
  findPositionOfBar as Z,
  _baseExtremum as _,
  interpolateNumber$2 as a,
  truncateByDomain as a0,
  getCateCoordinateOfBar as a1,
  getTooltipItem as a2,
  Bar as a3,
  formatAxisMap$1 as a4,
  useGetPenaltyExposure as a5,
  Legend as a6,
  isNil$1 as b,
  isNan as c,
  isEqual$1 as d,
  ...
  useGetComplianceRiskScore as u,
